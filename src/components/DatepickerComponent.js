            ...
            <CardContent>
              ...
              <div className="description">
                <div className="item-wrapper">
                  ...
                  <p>
                    Basic Datepicker implementstion needs to install packages
                  ...
                  <p>
                    By default, the day and year views are enabled. Use the{" "}
                    <strong>views</strong> prop to change this behavior:
                  </p>
                  <div className="datepicker-outer">
                    <LocalizationProvider dateAdapter={AdapterDayjs}>
                      <Box
                      ...
                      >
                        ...
                        />
                        <DatePicker sx={{width: "100%"}} label={'"day"'} views={["day", "month"]} />
                        <DatePicker sx={{width: "100%"}} label={'"month"'} views={["month"]}
                         monthsPerRow={4}
                          />
                        <DatePicker sx={{width: "100%"}} label={'"year"'} views={["year"]}
                         yearsPerRow={3} 
                         />
                        <DatePicker sx={{width: "100%"}}
                  ...
                  <p>
                    One can open it to month or year view using{" "}
                    <strong>openTo</strong> prop
                  </p>
                  <div className="datepicker-outer">
                    <LocalizationProvider dateAdapter={AdapterDayjs}>
                    <Box
